...
class _$ManagerImpl implements _Manager {
  ...
  @override
  String toString() {
    return 'Manager(id: $id, username: $username, password: $password, role: $role, name: $name, email: $email, tel: $tel, address: $address)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, username, password, role, name, email, tel, address);
...
abstract class _Manager implements Manager {
  factory _Manager(
      ...
      final String? email,
      final String? tel,
      final String? address}) = _$ManagerImpl;
